...
public class BuildingManager : MonoBehaviour{
    ...
    public event EventHandler<OnActiveBuildTypeChangedEventArgs> OnActiveBuildingTypeChanged;
    ...
    public void SetActiveBuildingType(BuildingTypeSO buildingType) {
        ...
        OnActiveBuildingTypeChanged?.Invoke(this, new OnActiveBuildTypeChangedEventArgs { activeBuildingType = activeBuildingType });
    }
        ...
        foreach (Collider2D collider2D in collider2DArray) {
            ...
            if (buildingTypeHolder != null) {
                ...
                if (buildingTypeHolder.buildingType == buildingType) {
                    //Theres already a building of this type inside this radius
